      ...
      <div className="max-w-[1250px]  mx-auto">
        ...
        <div className="mt-7">
          <p className="mt-6 text-gray-600 text-[20px] leading-10">
            ...
            Since writing my first line of code in 2022, I've been diving deeper
            every day. I've shared my journey on YouTube with over 250 videos
            and have completed more than 50 projects. I'm always eager to learn
          ...
          <ul className="flex justify-between gap-10 flex-col md:flex-row">
            <li className="w-full shadow-sm ">
              <div className="w-full text-center py-[30px] md:py-[60px] rounded-md bg-light-bg">
                ...
                <span className="uppercase">Youtube Subscriber</span>
              </div>
            </li>
            <li className="w-full shadow-sm ">
              <div className="w-full text-center py-[30px] md:py-[60px] rounded-md bg-light-bg">
                ...
                <span className="uppercase">Year of Experience</span>
              </div>
            </li>
            <li className="w-full shadow-sm ">
              <div className="w-full text-center py-[30px] md:py-[60px] rounded-md bg-light-bg">
